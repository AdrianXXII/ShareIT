...
return [
    ...
    'added-to-shared-object-content' => "Hello :NAME, \n\n :USERNAME shared :SHARED_OBJECT with you.",
    'conflicts' => "Conflict",
    'conflicting-reservations-personal-subject' => "Your current conflicting reservations",
    'conflicting-reservations-personal-content1' => "Here is a list of all of your currently conflicting Reservations: \n\n",
    ...
    'conflicting-reservations-template-personal-content1' => "Your recurring reservation for :SHARED_OBJECT has following conflicts: ",
    ...
    'conflicting-reservations-template-recipient-content1' => "Here is a list of reservations that are in conflict after :USERNAME created a recurring reservation: \n",
    ...
    'remove-to-shared-object-content' => "Hello :NAME, \n\n :USERNAME removed you from :SHARED_OBJECT.",
